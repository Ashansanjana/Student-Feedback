...
<div class="content">
    ...
    <tbody>
        ...
        // $feedbackQuery = "SELECT LF.LFeedbackID, LF.CourseCode, LF.StudentID, LF.StudentBatch, LF.LecID, LF.Rating, GROUP_CONCAT(LF.Rating) AS Feedbacks 
        // FROM lecturer_feedback LF
        // INNER JOIN question LFQ ON LF.LFeedbackID = LFQ.QuestionID
        // {$whereClause}
        // GROUP BY LF.LFeedbackID, LF.CourseCode, LF.StudentID, LF.StudentBatch, LF.LecID, LF.Rating";
