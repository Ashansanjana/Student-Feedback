    ...
    <?php include 'header.php'; ?>
        ...
        <div class="row offset-1 justify-content-center" id="row3">
           ...
           <div class="col-4">
            ...
            <?php
                $stmt = $pdo->query("SELECT DISTINCT course.CourseCode,course.CourseName FROM course INNER JOIN lecturer_course ON course.CourseCode = lecturer_course.CourseID WHERE lecturer_course.LecID= '$LecID' ");
            ?>
